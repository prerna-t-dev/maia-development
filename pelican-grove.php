...
<body id="bodycontainer">
    <div class="body_wrapper scroll-section overflow-x-hidden">
            ...
            <div class="container">
                <div class="hero-content pb-10 xl:pb-12">
                    <div class="flex flex-col-reverse xl:flex-row xl:justify-between xl:items-center gap-16 mb-6 xl:mb-16">
                        ...
                        <div class="dev-project--logo fade-in" data-delay="1.2" style="width: 260px; height: auto;">
                            <img class="w-full h-auto" src="images/2025/pelican-grove/pelican-grove-logo.png" alt="Pelican Gardens Logo">
                        </div>
                    </div>
                    <div class="flex flex-col gap-6 mb-16 xl:mb-20">
                         <h1 class="text-56px xl:text-7xl font-normal text-white larger-text-size">
                            ...
                            <span class="line-wrapper">
                                <span class="line">Lakeside Sanctuary</span>
                            </span>
                        </h1>
                        <div class="fade-in" data-delay="0.8">
                            <p class="font-medium text-white opacity-70" style="max-width: 720px;">
                                Rising along Jakkur Lake, Pelican Grove blends abundant flora and fauna with seamless indoor-outdoor living and serene connectivity.
                            </p>
                        </div>
                ...
                <div class="hidden xl:block">
                    <!-- <div class="hero-image-wrapper hero-image-wrapper-desktop"> -->
                        <img src="images/2025/pelican-grove/hero-banner-image--dev-desktop.png" alt="Hero Banner Image" class="hero-banner-image">
                    <!-- </div> -->
                </div>
                <div class="block xl:hidden">
                    <!-- <div class="hero-image-wrapper hero-image-wrapper-mobile"> -->
                        <img src="images/2025/pelican-grove//hero-banner-image--dev-mobile.png" alt="Hero Banner Image" class="hero-banner-image">
                    <!-- </div> -->
                </div>
            </div>
        </section>
        ...
        <section class="key-features py-30 bg-beige overflow-hidden">
            <div class="container">
                <div class="grid grid-cols-1 xl:grid-cols-[1.4fr_1fr] items-center gap-14">
                    ...
                    <div class="img-wrapper">
                        <img src="images/2025/pelican-grove/pelican-grove--features.png" alt="Key Features Image">
                    </div>
                </div>
        ...
        <section class="development-location py-30 xl:pt-50 bg-white">
            <div class="container">
                ...
                <div class="text-reveal--wrapper">
                    <h2 class="text-40px xl:text-6xl font-normal mb-12 xl:mb-30 text-green text-center">
                        The best of lakeside living  <br />
                        & city comfort
                    </h2>
                </div>
            </div>
            ...
            <div class="px-5 xl:px-0 my-20">
                <div class="location--map">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.2464244800003!2d77.60374368054583!3d13.083562879539766!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae19ffe1614557%3A0x4fd5d3730781206b!2sMAIA%20Pelican%20Grove!5e0!3m2!1sen!2sin!4v1757675432711!5m2!1sen!2sin"
                        width="100%" 
                        height="500" 
                        style="border:0;" 
                        allowfullscreen="" 
            ...
            <div class="relative">
                <div class="gallery--images">
                    ...
                    <div class="gallery--slide" data-categories="residences">
                        ...
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--residences--1.jpg" alt="Residences Gallery Image 1">
                    </div>
                    <div class="gallery--slide" data-categories="residences">
                        <div class="slide-number">Slide 2</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--residences--2.jpg" alt="Residences Gallery Image 2">
                    </div>
                    <div class="gallery--slide" data-categories="residences">
                        <div class="slide-number">Slide 3</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--residences--3.jpg" alt="Residences Gallery Image 3">
                    </div>
                    <div class="gallery--slide" data-categories="residences">
                        <div class="slide-number">Slide 4</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--residences--4.jpg" alt="Residences Gallery Image 4">
                    </div>

                    <!-- Facade Images (9) -->
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 5</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--1.jpg" alt="Facade Gallery Image 1">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 6</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--2.jpg" alt="Facade Gallery Image 2">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 7</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--3.jpg" alt="Facade Gallery Image 3">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 8</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--4.jpg" alt="Facade Gallery Image 4">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 9</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--5.jpg" alt="Facade Gallery Image 5">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 10</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--6.jpg" alt="Facade Gallery Image 6">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 11</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--7.jpg" alt="Facade Gallery Image 7">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 12</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--8.jpg" alt="Facade Gallery Image 8">
                    </div>
                    <div class="gallery--slide" data-categories="facade">
                        <div class="slide-number">Slide 13</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--facade--9.jpg" alt="Facade Gallery Image 9">
                    </div>

                    <!-- Amenities Images (11) -->
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 14</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--1.jpg" alt="Amenities Gallery Image 1">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 15</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--2.jpg" alt="Amenities Gallery Image 2">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 16</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--3.jpg" alt="Amenities Gallery Image 3">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 17</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--4.jpg" alt="Amenities Gallery Image 4">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 18</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--5.jpg" alt="Amenities Gallery Image 5">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 19</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--6.jpg" alt="Amenities Gallery Image 6">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 20</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--7.jpg" alt="Amenities Gallery Image 7">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 21</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--8.jpg" alt="Amenities Gallery Image 8">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 22</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--9.jpg" alt="Amenities Gallery Image 9">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 23</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--10.jpg" alt="Amenities Gallery Image 10">
                    </div>
                    <div class="gallery--slide" data-categories="amenities">
                        <div class="slide-number">Slide 24</div>
                        <img src="images/2025/pelican-grove/gallery-pelicangrove--amenities--11.jpg" alt="Amenities Gallery Image 11">
                    </div>
                </div>
