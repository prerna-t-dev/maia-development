    ...
    <div class="body_wrapper scroll-section overflow-x-hidden">
        ...
        <section class="our-purpose-mission-vision bg-green-dark pt-30 pb-20 xl:pt-44 xl:pb-40">
                    ...
                    <h2 class="text-40px xl:text-7xl font-normal mb-12 xl:mb-32 text-white xl:pr-24 larger-text-size">
                        ...
                        <div class="text-reveal--wrapper">
                            <span class="block xl:hidden">
                                Anticipating Needs to 
                                Create Effortless, Daily
                                Living
                            </span>
                        </div>
                    </h2>
            ...
            <div class="pl-5 xl:pl-24">
                ...
                <div class="pr-5 mt-10 mb-24 xl:mt-32 xl:mb-30">
                        ...
                        <div class="flex flex-col xl:flex-row items-center gap-8 xl:gap-16">
                            ...
                            <div class="xl:pr-20">
                                ...
                                <p class="text-gold  pr-10 xl:pr-0 text-sm xl:text-base">
                                    Host gatherings seamlessly, with concierge planning and execution on call.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="maialife-services-slider-item">
                        <div class="flex flex-col xl:flex-row items-center gap-8 xl:gap-16">
                            ...
                            <div class="xl:pr-20">
                                ...
                                <p class="text-gold  pr-10 xl:pr-0 text-sm xl:text-base">
                                Eco-smart cleaning and systems preserve resources while maintaining pristine homes.
                                </p>
                            </div>
                        </div>
                    </div> -->
            ...
            <div class="container">
                ...
                <div class="bg-beige px-10 py-14 xl:px-14 xl:py-14">
                    ...
                    <div class="flex flex-col xl:flex-row xl:items-center gap-8">
                        <div class="image-reveal--wrapper w-22 xl:w-875">
                    ...
                    <div class="line-divider-plain-beige mt-14 xl:mt-10 xl:mb-12"></div>
                </div>
