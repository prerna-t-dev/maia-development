...
<meta charset="UTF-8">
    ...
    <script>
        // Initialize Lenis smooth scrolling (deferred)
        function initLenis() {
    ...
    <script async src="https://cdn.jsdelivr.net/gh/studio-freight/lenis@1/bundled/lenis.min.js" onload="initLenis()"></script>
    <script async src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js" onload="initGSAP()"></script>
    <script async src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js"></script>
    <script async src="https://cdn.jsdelivr.net/npm/gsap@3.13.0/dist/SplitText.min.js"></script>
...
<body id="bodycontainer">
    <div class="body_wrapper scroll-section overflow-x-hidden">
        ...
        <div id="nav-overlay" class="nav-overlay fixed w-screen h-screen bg-green-footer z-50">
            ...
            <div class="container w-full flex justify-between items-center absolute top-0 left-0 right-0" style="padding-top: 6px;">
                ...
                <div class="menu-bar flex items-center gap-4">
                    <!-- Contact Us - Desktop -->
                    <a class="nav-overlay-contact-us hidden xl:flex btn-secondary bg-white w-fit text-green uppercase px-6 py-3 rounded-full flex gap-2 items-center cursor-pointer">
                        <svg width="6" height="7" viewBox="0 0 6 7" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container_">
                ...
                <div class="hero-video-wrapper" style="height: 100vh;">
                    ...
                    <div class="hero-video-placeholder">
                        <img src="images/2025/homepage/maia-home-hero-placeholder.jpg" alt="Hero Banner" class="hero-placeholder-image">
                    ...
                    <video class="hero-video-desktop hidden xl:block" muted loop playsinline preload="none" data-src="images/2025/homepage/maia-home-hero-video--desktop.mp4">
                        <source data-src="images/2025/homepage/maia-home-hero-video--desktop.mp4" type="video/mp4">
                    </video>
                    
                    <!-- Mobile Video (lazy loaded) -->
                    <video class="hero-video-mobile block xl:hidden" muted loop playsinline preload="none" data-src="images/2025/homepage/maia-home-hero-video--mobile.mp4">
                        <source data-src="images/2025/homepage/maia-home-hero-video--mobile.mp4" type="video/mp4">
                    </video>
                </div>
        ...
        <section class="maia-developments pt-20 xl:pt-30 bg-white">
            ...
            <div class="animation-test-3-wrapper">
                <div class="animation-test-3  mt-20"> 
                  <section class="first">
                    <div class="outer">
                      <div class="inner">
                        <a href="27-summit.html" target="_blank" class="bg one">
                          <!-- <h2 class="section-heading">1. 27 Summit</h2> -->
                            ...
                            <img src="images/2025/homepage/dev-project--1.png" alt="27 Summit" class="bg-img">
                        </a>
                      </div>
                    </div>
                  </section> 
                    ...
                    <div class="outer">
                      <div class="inner">
                        <a href="pelican-gardens.html" target="_blank" class="bg">
                          ...
                          <img src="images/2025/homepage/dev-project--3.png" alt="Pelican Gardens" class="bg-img">
                        </a>
                      </div>
                    </div>
                  </section>
                  ...
                  <style>
                    ...
                    .animation-test-3 section .bg h2{
                        color: white;
            ...
            <!-- Development Project List: Removed -->
        ...
        <section class="in-the-news py-20 xl:py-40 xl:pb-50 bg-white">
            <div class="container">
    ...
    <script async src="sliders.js"></script>
